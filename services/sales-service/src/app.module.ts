...
@Module({
  imports: [
    ConfigModule.forRoot({
      isGlobal: true,
      load: [databaseConfig, redisConfig, jwtConfig, appConfig, rabbitmqConfig, salesConfig, cashClosingConfig, fneConfig],
    }),
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (cfg: ConfigService) => ({
        ...
        entities: [Client, Product, Sale, SaleItem, Payment, Receivable, CashDay, CashMovement, AuditLog, FneInvoice, FneInvoiceItem, FneApiLog, FneClient, FneProduct, FnePointOfSale, FneEstablishment, FneSetting, FneAccountingEntry],
        synchronize: false,
