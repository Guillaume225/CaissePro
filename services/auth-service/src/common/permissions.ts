...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  'da.process': 'Générer le bon de commande (achats)',
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  DAF: [
    ...
    PERMISSIONS.EXPENSE_APPROVE_L2,
    ...
    PERMISSIONS.CASH_CLOSING_VALIDATE,
  ],
  ...
  CAISSIER_DEPENSES: [
    ...
    PERMISSIONS.BUDGET_READ,
    PERMISSIONS.DASHBOARD_READ,
    PERMISSIONS.CASH_CLOSING_CREATE,
    PERMISSIONS.CASH_CLOSING_READ,
  ],
  ...
  FACTURIER_FNE: [
    PERMISSIONS.FNE_CREATE,
    PERMISSIONS.FNE_READ,
    PERMISSIONS.FNE_UPDATE,
    PERMISSIONS.FNE_CREDIT_NOTE,
    PERMISSIONS.CLIENT_CREATE,
    PERMISSIONS.CLIENT_READ,
    PERMISSIONS.CLIENT_UPDATE,
    PERMISSIONS.PRODUCT_READ,
